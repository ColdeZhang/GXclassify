...
def outputPage(brow, objectName, trashType):
    ...
    ex.updatePage('<html><body bgcolor="black"><span ></span><h1>工程训练自动垃圾分类系统</h1><p>&nbsp;</p><div class="container-fluid"><div class="row-fluid"><div class="span7" style="width: 50%; margin-left: 5% ; float: left; height: 80%"><img src="res/UI_res/input_img.jpeg" width="100%"  alt=""/> </div><div class="span5" style="width: 40%; margin-right: 5%; float: left; height: 80%"><div class="row-fluid"><div class="span12" style="text-align: center; width: inherit;height: 30%;line-height: 120px;font-size: 80px；color: #ffffff">{}</div></div><div class="row-fluid" ><div class="span4" style="margin-left: 5%; width: 45%; float: left; text-align: center; height: 70%; line-height: 240px; font-size: 36px; font-weight: 500；color: #ffffff">属于</div><div class="span8" style="margin-right: 5%; width: 45%; float: left; text-align: center;;margin-top: 15%"><img src="res/UI_res/{}.jpg" width="100%"alt=""/> </div></div></div></div></div></body></html>'.format(objectName, trashType, trashType))
    brow.refresh()
    pass
