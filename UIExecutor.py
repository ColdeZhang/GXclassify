...
def videoPage(brow):
    ...
    ex.updatePage('<html><body bgcolor="black"><span ></span><h1 style="color: #ffffff">工程训练自动垃圾分类系统</h1><p>&nbsp;</p><div style="text-align: center; width: 100% "><video width="650%" autoplay="autoplay" loop="loop"><source src="res/UI_res/video.webm" type="video/webm"></video></div></body></html>')
    brow.refresh()
    pass
